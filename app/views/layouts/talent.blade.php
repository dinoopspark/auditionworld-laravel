...
<script src="{{ URL::asset('assets/js/jquery-1.10.0.min.js')}}"></script>  
...
<script src="{{ URL::asset('assets/js/jquery-1.7.js')}}"></script> 
<script type="text/javascript" src="<?php echo URL::asset('assets/js/jquery.autocomplete.js')?>"></script>
...
<link href="{{ URL::asset('assets/css/token-input.css')}}" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="{{ URL::asset('assets/js/jquery.tokeninput.js')}}"></script>
  <script>
