...
<title>Malayalam Film Audition</title>
<meta content="All upcoming and Previous auditions listed here. Apply to Auditions after registering to Auditionworld" name=description />
...
<div id="example-one">
        	...
        	<ul class="nav">
                <li class="nav-one"><a href="#featured" class="current"> <h2> Upcoming Auditions </h2></a></li>
                <li class="nav-two"><a href="#core"> <h2 class="nav-2">Previous  Auditions </h2></a></li>  
...
<input name="gender" type="radio" value="female" class="rad"> 
          ...
          <div class="reg-col2">
             <input name="dob" id="dob" type="hidden" class="rg-text-small reg_clear" placeholder="Date Of Birth" value=""> 
...
<!--<option>Model</option> -->
          ...
          <div class="reg-col1"> 
             ...
             <div class="fileUpload ">
                 ...
                 <input id="uploadBtn" name="profile_pic" type="file" class="upload reg_clear" />
</div>
