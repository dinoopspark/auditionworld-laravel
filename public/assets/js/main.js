...
function cancelupload() {
    ...
    $("#video_title").val('');
    $('#description').val('');
    $("#direct-upload-text").prop('disabled', true);
}
function initDirectUpload() {
    ...
    fileInput.onchange = function (e) {
        ...
        var x = $("#filepicker-input");
//    	if(x[0].files[0]['type'] != 'video/mp4') {
//        alert("Please upload mp4 video files");
//       return;
//    	}
        $("#dropped-files").html("");
        ...
        var uploadcancelButton = document.getElementById('uploadcancelbutton');
        uploadcancelButton.style.display = 'inline-block';
        ...
        uploadButton.onclick = function (e) {
            ...
            uploadcancelButton.onclick = null;
            // uploadButton.style.display = 'none';
            // uploadcancelButton.style.display = 'none';
            $("#uploadbutton").prop('disabled', true);
            $("#uploadcancelbutton").prop('disabled', true);
            document.getElementById('ajax-loader').style.display = 'inline';
            setTimeout(function () {
                $('#ajax-loader').fadeOut()
            }, 2000);  //fade out loader after 2 sec
            startupload(files);
        };
    }
}
                        ...
                        progressHandler: function (percent, serverFileId) {
                            ...
                            $('#progressbar-' + i + ' .ui-progressbar-value').addClass('ui-corner-right').stop(true).animate({
                                ...
                                if (percent == 100) {
                                    ...
                                    // succeedImg.src  = '/dashboard/public/image/succeed-tick.png';
...
// 	// 		var succeedImg 	= document.createElement('img');
// 	// 		succeedImg.src  = '../image/succeed-tick.png';
// 	// 		succeedImg.style.cssFloat = 'right';
// 	// 		succeedImg.width = 40;
